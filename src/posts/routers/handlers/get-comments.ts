...
export const getCommentsByPostId =async (req: Request<{postId:string},{},{},PaginatedOutput>, res: Response) => {
    ...
    try{
        ...
        const pagginationComments=mapCommentsPagination(getComments,queryInput.pageNumber,queryInput.pageSize)
