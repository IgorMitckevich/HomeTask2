...
get('/', findAllPosts)
    ...
    .post('/', adminGuard,postValidation,inputValidationResultMiddleware, createPosts)
    .put(`/:id`,adminGuard,postValidation,inputValidationResultMiddleware, updatePostsById)
