...
export async function updateCommentById(req: Request<{commentId:string},{},CommentInputModel>, res: Response) {
   try{
       ...
       const resultOfUpdateComment=await commentsService.updateComment(req.body,commentId)
