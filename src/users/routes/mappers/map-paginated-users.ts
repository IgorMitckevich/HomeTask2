...
export function mapPaginatorUserViewModel(users:{items:WithId<UserViewModel>[];totalCount:number},pagesNumber:number,pageSize:number):PaginatorUserViewModel {
